...
\email{calvin_leung@berkeley.edu}
...
\section{Single-pulse localization - Calvin writes}
...
We found that the CHIME baseband localization consistently performs poorly on the low-declination pulsars B0919+06 and B1642-03. We attribute this to the lower sensitivity and beam effects which distort localizations at such low declinations.

were omitted from this sample.
