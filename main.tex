...
\subsection{North-south localization of pulsars}
...
Describe spectra collection: a paragraph for each FRB, with what resource it was observed (Gemini? Keck? Lick?), 
Reduction details – progress?
SED fits – Mass, parametric SFR – fit archival photometry (CIGALE?)
Macquart Diagram
\section{Radio Counterparts}
PRS upper limits from VLASS comment on presence/absence of radio SF in the HG.
