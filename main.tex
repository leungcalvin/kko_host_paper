...
\section{VLBI Localization - Calvin writes}
Single-pulse VLBI localization represents a new frontier in VLBI astrometry. Due to sparse $uv$ coverage and the transience of the signal, it is critical to realistically assess the magnitude of typical localization uncertainties. We do this using pulsar localizations at a variety of declinations. Since the typical shape of our localizations are east-west

\subsection{Pulsar Observations}
We observed the following pulsars:

FIGURE: BB localization validation test: declination errors for a bunch of pulsars.
