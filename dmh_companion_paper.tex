...
One of the earliest landmarks in observational FRB science used the Australian Square Kilometre Array Pathfinder (ASKAP)~\citep{macquart2020census} to locate the missing baryons to the intergalactic medium (IGM). That result established that the mean contribution from the intergalactic medium is the dominant contributor to the DM of an FRB for sources beyond $z \sim 0.2$, establishing what FRB astronomers now refer to as the ``Macquart relation''. 

An implied conclusion of~\citet{macquart2020census}, whose eponymous relation now extends to $z_h =  1.3$~\citep{ryder2023luminous,connor2024gas}, is that the contribution from the host galaxy is typically subdominant to that of the IGM. Nevertheless, the host galaxy DM contribution (hereafter, \dmh) is worthy of dedicated study: it is crucial to virtually all attempts to forward model FRB dispersion measures as probes of ionized gas~\citep{james2021z,james2022measurement,rafiei_ravandi2021chime,2019arXiv190102418M}, and contains valuable information about the circumgalactic medium (CGM) of FRB hosts\citep{prochaska2019probing}.

Previous efforts to study galactic halos using FRBs have relied on a ``wedding-cake'' combination of multi-object spectroscopic surveys to decompose the overall DM budget of FRB sightlines into simultaneously solve for the contributions from interlopers and the host galaxy halo to the ~\citep{khrykin2024flimflam}. In this paper, we focus on the latter by selecting empty sightlines towards localized, low-redshift FRBs in the literature, whose total number now exceeds 100. 
Previous efforts to study galactic halos using FRBs have relied on a ``wedding-cake'' combination of multi-object spectroscopic surveys to decompose the overall DM budget of FRB sightlines into contributions from interlopers and the halo of the host galaxy~\citep{khrykin2024flimflam}. In this paper, we focus only the latter by selecting empty sightlines towards localized, low-redshift FRBs in the literature, whose total number now exceeds 100. 
