...
In this paper we aim to characterize the contribution of the circumgalactic medium of the FRB host to the dispersion measure budget. The circumgalactic contribution is a significant contributor to, but distinct from, the host contribution in its own rest frame. The former has physical significance as a characterization of the gas column surrounding a galaxy, but cannot easily be measured from data. The latter can readily be measured from data (\dmh in Eq.~\ref{eq:dmh_definition}), but only constitutes an upper limit on the former. We have
\begin{equation}
