...
\newcommand{\dmmwism}{\ensuremath{\rm DM}
...
After subtracging the Milky Way DM, the extragalactic DM can be  its host, and intervening contributions such as diffuse IGM and the CGM of intervening galaxies.
\begin{equation}
    \dm = \int_{0}^{z_F} n_e(z)~dz = \dmmwism + \dmmwhalo + \dmcosmic + \underbrace{\dmhhalo + \dmhism + \dmcbm}_{\dmh}
\end{equation}
...
The second class of study traces the residuals after subtracting the mean DM at a certain redshift.
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{figures/sk.pdf}
