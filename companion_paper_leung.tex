...
In this paper we aim to characterize the contribution of the circumgalactic medium of the FRB host to the dispersion measure budget. The circumgalactic contribution is a significant contributor to, but distinct from, the host contribution in its own rest frame (\dmh in Eq.~\ref{eq:dmh_definition}).
\begin{equation}
...
\section{The Host DM and its Moments}
...
\section{The DM-host stellar mass relation}
