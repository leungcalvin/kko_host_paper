...
We see in Fig.~\ref{fig:camels} that our predictions from the ASTRID hydrodynamical simulations are challenged at the high-$M^*$ end by our data, which show a qualitatively different behavior. This implies a certain level of suppression of the matter power spectrum shown in Fig.~\ref{fig:sk}, in which we have shown the predictions for the suppression in the matter power spectrum from each of the CAMELS simulations we have used in our \dmh\ measurements.
